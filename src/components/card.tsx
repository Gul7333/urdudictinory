  ...
  return (
    <article className="font-urdu text-right leading-loose px-4 py-6">
      ...
      <section aria-labelledby="description">
        <h2 id="description" className="text-xl text-blue-700 font-bold mt-6">
          تفصیلات
        </h2>
        <p>{item[3]}</p>
      ...
      {noun.length > 0 && (
        <section aria-labelledby="noun">
          <h2 id="noun" className="text-xl text-blue-700 font-bold mt-4">
            اسم
          </h2>
      ...
      {nountypes.length > 0 && (
        <section aria-labelledby="nountypes">
          <h2 id="nountypes" className="text-xl text-blue-700 font-bold mt-4">
            اقسام اسم
          </h2>
      ...
      {meaningtitles.length > 0 && (
        <section aria-labelledby="meanings">
          <h2 id="meanings" className="text-xl text-blue-700 font-bold mt-4">
            {item[1]} کے معنی
          </h2>
      ...
      {Array.isArray(details.alternatives) &&
        details.alternatives.length > 0 && (
          <section aria-labelledby="alternatives">
            <h2
              id="alternatives"
              className="text-xl text-blue-700 font-bold mt-4"
            >
              {item[1]} کے مترادف
            </h2>
      ...
      {Array.isArray(details.compounds) && details.compounds.length > 0 && (
        <section aria-labelledby="compounds">
          <h2 id="compounds" className="text-xl text-blue-700 font-bold mt-4">
            مرکبات
          </h2>
      ...
      {Array.isArray(details.poetry) && details.poetry.length > 0 && (
        <section aria-labelledby="poetry">
          <h2 id="poetry" className="text-xl text-blue-700 font-bold mt-4">
            شاعری
          </h2>
      ...
      {Array.isArray(details.idioms) && details.idioms.length > 0 && (
        <section aria-labelledby="idioms">
          <h2 id="idioms" className="text-xl text-blue-700 font-bold mt-4">
            محاورات
          </h2>
          <ul className="list-disc pr-5">
